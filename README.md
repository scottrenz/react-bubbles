...
A token is used to ensure a person authorized is on the site.
If the person logs in properly, a token is return
The code can then use the token to determine what the user can see and do.

- [ ] What steps can you take in your web apps to keep your data secure?

You can require a log in and make sure things don't get seen if there was not a proper login.

- [ ] Describe how web servers work.

Web servers are alway online so long as there is not a technical issue. They receive requests through the internet connection and if they have the data available and the user is authorized, they send back the data requested to the IP address that asked for it.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

Create, read, update and delete can be handled with put, get, post, and delete.
